...
NavigationDrawerFragment.NavigationDrawerCallbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.addTab(actionBar.newTab()
				.setText(R.string.product_section1)
				.setTabListener(this));

		actionBar.addTab(actionBar.newTab()
				.setText(R.string.product_section2)
				.setTabListener(this));

		actionBar.addTab(actionBar.newTab()
				.setText(R.string.product_section3)
				.setTabListener(this));
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.product_section1).toUpperCase(l);
			case 1:
				return getString(R.string.product_section2).toUpperCase(l);
			case 2:
				return getString(R.string.product_section3).toUpperCase(l);
			}
			return null;
		}
	}
